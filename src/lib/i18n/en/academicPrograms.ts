        ...
        countries: {
          usa: {
            courses: [
              ...
              {
                title: 'Chelation Serum Therapy and Principles of Applied Regenerative Medicine',
                description: 'Explore chelation and the fundamentals of regenerative medicine.',
                image: '@/assets/img-heros/img-hero-cursos/suero-USA.png',
              ...
              },
              {
                ...
                image: '@/assets/img-heros/img-hero-cursos/flebotomia-USA.png',
            ...
            courseDetails: {
              ...
              'intravenous-therapy-chelation': {
                ...
                targetAudience: {
                  ...
                  description: 'Regenerative Medicine and Serum Therapy have proven to be areas with a significant impact on patient health and well-being. However, worldwide, complications have arisen due to the improper practice of these treatments, often carried out by personnel lacking adequate training.\n\nFor this reason, our program is designed for healthcare professionals, providing them with the tools and knowledge necessary to apply these therapies safely and effectively.\n\nAt **INSTITUTO MEX-COL-USA**, we responsibly take on the challenge of ensuring these situations do not occur, promoting proper training for all specialists involved in these practices.\n\nWe focus on preparing professionals who apply Regenerative Medicine and Serum Therapy with safety, ethics, and excellence, always safeguarding the health and well-being of their patients.'
                },
                curriculum: [
                  {
                    title: '**Day 1 – Serum Therapy:**',
                    topics: [
                      'In this Serum Therapy course, participants will acquire comprehensive knowledge of advanced techniques to optimize patient health, energy, and well-being.\n\nYou will learn to apply therapies that enhance neurostimulation, cellular oxygenation, and overall revitalization, as well as specific treatments to strengthen the immune system, stimulate metabolism, and combat signs of aging.\n\nAdditionally, you will learn the safe and effective use of key active ingredients, from vitamins and minerals to specialized compounds, understanding their biochemical and pharmacological properties and therapeutic applications for conditions such as obesity, overweight, psoriasis, osteoarticular pain, and autoimmune diseases.\n\nThe course also provides tools for heavy metal elimination, reduction of atheromatous plaque, and optimization of cardiovascular health, all with a focus on safety, ethics, and clinical efficacy.\n\nUpon completion, you will be prepared to implement Serum Therapy protocols professionally, safely, and oriented toward the holistic well-being of your patients.'
                    ]
                  },
                  {
                    title: '**Day 2 – Regenerative Medicine:**',
                    topics: [
                      'In this second day, you will deepen the principles, processing, and biological functions of regenerative therapies, learning their indications, medical uses, proper dosages, and safety considerations.\n\nYou will learn the fundamentals of cell differentiation, angiogenesis, and immunomodulation, as well as the practical application of Mesenchymal Stem Cells through audiovisual materials.\n\nYou will explore the biological functions of exosomes, their indications and safe use, and observe practical application examples through instructional videos.\n\nLikewise, you will become familiar with placental implants, understanding their principles, indications, dosages, and safety profile, accompanied by video demonstrations.\n\nThe day also includes Serum Therapy sessions, addressing revitalizing and immune-stimulating therapies, focused on obesity and overweight, and basic chelation for heavy metal removal, allowing you to integrate these protocols safely and effectively into your professional practice.\n\nUpon completion of this module, you will be prepared to apply advanced techniques in both Regenerative Medicine and Serum Therapy, combining theoretical and practical knowledge to offer safe, effective treatments that focus on the holistic well-being of patients.'
                    ]
                  }
                ],
                includes: [
                ...
                accreditations: [
                  '**Accreditations and Institutional Support :**\n\nThe courses and updates we provide, being continuing education, are registered with the **Secretaría del Trabajo y Previsión Social (STPS)**.\n\nUpon completing the practical training, participants will undergo an assessment of knowledge, skills, and proficiency. A minimum score of 80% is required to receive the certificate, which will be issued after **INSTITUTO MEX-COL-USA** evaluates and confirms that each participant passed.\n\n**Certificate of Attendance and Participation:** Issued by **INSTITUTO MEX-COL-USA**, certifying active participation and completion of the theoretical and practical modules, providing academic and formative support.\n\n**Diploma:** Issued by the **American Alliance of Aesthetic Medicine** and **SOPEME (United States Aesthetic Medicine Association)**, valid to authenticate training in the USA, Latin America, Caribbean, and Spain as recognized continuing education.'
                ],
                productQuality: {
                  title: 'Quality Products and Guaranteed Safety',
                  description: '**INSTITUTO MEX-COL-USA** works with laboratories that ensure reliability and confidence in their products, guaranteeing quality in all practices conducted and sharing information about these providers at our locations.\n\nIt is important to note that we do not sell products on-site nor promote specific brands, as acquisition choices must be free and responsibly made by each student. Each participant is responsible for verifying suppliers, as well as checking local permissions, registrations, regulations, and any other legal aspects in their city or country before purchasing any product.'
                }
              },
            ...
            courseDetails: {
              'facial-harmonization-course': {
                ...
                testimonial: {
                  ...
                  subtitle: 'Course in Modeling, Profiling and Facial Harmonization',
                  videoId: 'fThNwH7dFCw'
                }
              },
          ...
          colombia: {
            courses: [
              ...
              },
              {
                ...
                description: '4-day in-person course (2 theoretical + 2 practical) to specialize in minimally invasive facial rejuvenation techniques with immediate results.',
            ...
            courseDetails: {
              'master-class-facial-modeling': {
                ...
                overview: [
                  ...
                  'Complete protocols on indications, contraindications, and adverse event management',
                  'International certification endorsed by American Alliance of Aesthetic Medicine and SOPEME',
                  'Certificate registered with STPS (Mexico) with curricular validity',
                  'Products included: Juvederm-Allergan, Botox-Allergan, PDO Threads, Harmonyca/Radiesse',
                  'Knowledge, skills, and proficiency evaluation upon completion',
                ],
                targetAudience: {
                  title: 'Course Intended For',
                  highlighted: 'Physicians and Dentists',
                  description: 'Worldwide, numerous complications have occurred in aesthetic medicine treatments, many caused by procedures performed by unqualified or untrained personnel. At INSTITUTO MEX-COL-USA, we responsibly accept the challenge of contributing to preventing these negligences from happening anywhere in the world. We are committed to training medical professionals and dentists, ensuring each treatment is performed with the highest standards of safety, ethics, and scientific knowledge.'
                },
                objectives: [
                ...
                prerequisites: [
                  'Professional degree in Medicine or Dentistry',
                  'Valid professional license',
                  'Commitment to patient ethics and safety',
                  'No prior experience in aesthetic medicine required',
                ],
                accreditations: [
                  'Certificate of attendance and participation issued by INSTITUTO MEX-COL-USA',
                  'Diploma issued by American Alliance of Aesthetic Medicine and SOPEME',
                  'Valid in the United States, Latin America, Caribbean, and Spain',
                  'Registered with the Ministry of Labor and Social Welfare - STPS (Mexico)',
                  'Knowledge, skills, and proficiency evaluation (minimum 80% to pass)',
                ],
                includes: [
                ...
                productQuality: {
                  ...
                  footer: 'In this way, we guarantee that each procedure is performed with safe, reliable, and approved supplies, offering our students and patients the peace of mind of working with the best in the market.'
                },
                testimonial: {
                  title: 'Real Testimonial',
                  subtitle: 'Facial Modeling, Profiling and Harmonization Course',
                  videoId: 'fThNwH7dFCw',
                  description: 'Hear the experience of our students who have successfully completed this course.'
                },
              },
              'intravenous-therapy-online': {
                ...
                format: 'Online',
                duration: '2 days',
                schedule: '9:45 AM - 6:00 PM approx',
                location: 'Online',
                certification: 'Yes',
                targetAudience: {
                  title: 'Course Intended For:',
                  ...
                  description: [
                    ...
                    'At INSTITUTO MEX-COL-USA, we responsibly accept the challenge of contributing to preventing these situations, promoting proper training for all specialists involved in these practices.',
                ...
                curriculum: [
                  {
                    ...
                    topics: [
                      ...
                      'Upon completion, you will be prepared to implement Serum Therapy protocols with a professional, safe approach oriented to your patients\' comprehensive well-being.'
                    ]
                  },
                  {
                    title: 'Day 2 - Regenerative Medicine',
                    topics: [
                      ...
                      'The day also includes Serum Therapy sessions, addressing revitalizing therapies, immunostimulants, focused on obesity and overweight, and basic chelation for metal elimination, allowing you to integrate these protocols safely and effectively into your professional practice.',
                      'Upon completing this module, you will be prepared to apply advanced Regenerative Medicine and Serum Therapy techniques, combining theoretical and practical knowledge to offer safe, effective treatments oriented to your patients\' comprehensive well-being.'
                    ]
                  }
                ],
                includes: [
                ...
                accreditations: [
                  ...
                  'Diploma: Issued by the American Alliance of Aesthetic Medicine and SOPEME (United States Association of Aesthetic Medicine), valid for authenticating training in the United States, Latin America, Caribbean, and Spain as recognized continuing education.'
                ],
                productQuality: {
                  title: 'Quality Products and Guaranteed Safety',
                  description: 'INSTITUTO MEX-COL-USA works with laboratories that guarantee and build trust in their products, ensuring quality in each of the practices performed, and sharing information about these suppliers at our locations.\n\nIt is important to note that we do not sell products at our facilities nor promote specific brands, as the choice of acquisition must be free and responsible on the part of the student. Each participant is responsible for verifying from whom to purchase, as well as reviewing permits, registrations, local regulations, and any other legal aspect in force in their city or country before acquiring any product.',
                  certifications: [],
                  footer: ''
                },
              },
              'mini-lifting-colombia': {
                ...
                targetAudience: {
                  ...
                  description: [
                    'The "Mini 3-Point Facial Lifting Rejuvenation Technique" (Minimally Invasive) course is designed for medical professionals worldwide who wish to expand their knowledge and perfect their skills in minimally invasive facial rejuvenation techniques.',
                    'Aesthetic physicians, dermatologists, plastic surgeons, and dentists specialized in aesthetics can participate.',
                    'This program is ideal for those seeking to strengthen their professional profile, offer innovative treatments to their patients, and stay at the forefront of facial aesthetic medicine. Although prior experience in this specific technique is not required, previous clinical training will be valued.',
                    'Upon completion of the course, participants will be trained to safely and effectively apply the Mini 3-Point Facial Lifting technique, achieving visible aesthetic results and increasing opportunities within their medical practice.',
                ...
                curriculum: [
                  {
                    ...
                    topics: [
                      ...
                      'Additionally, patient assessment and appropriate selection according to their profile will be addressed, ensuring optimal and personalized results. The training includes applied surgical technique, clinical case review, and supervised practice with patients, allowing physicians to apply the technique safely and effectively.',
                      ...
                      'This training provides participants with the necessary skills to apply highly effective and precise treatments, strengthening their professional profile in aesthetic medicine and expanding opportunities to offer innovative and safe solutions to their patients.'
                    ]
                  }
                ],
                includes: [
