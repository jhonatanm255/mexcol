              ...
              'master-class-4-techniques': {
                ...
                curriculum: [
                  ...
                  },
                  {
                    title: 'Día 2',
                    topics: [
                      '1. Práctica demostrativa. **(Debido a regulaciones y licencias de los alumnos, no será posible realizar prácticas directas con pacientes. La actividad se llevará a cabo únicamente de manera demostrativa por parte del instructor).**\n',
                      '2. Entrega de constancias de participación emitidas por el **Instituto Mex-Col-Usa.**\n',
                      '3. Registro fotográfico como evidencia del curso.\n',
                      '4. Examen final (se requiere una calificación mínima del **80%** para aprobar).\n',
                      '5. En caso de aprobación, se otorgará **Diploma avalado por la Alianza Americana de Medicina Estética de los Estados Unidos.**'
                    ]
                  }
                ],
                includes: [
