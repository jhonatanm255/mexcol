            ...
            courseDetails: {
              'facial-harmonization-course': {
                ...
                testimonial: {
                  ...
                  subtitle: 'Curso de Modelación, Perfilación y Armonización Facial',
                  videoId: 'fThNwH7dFCw'
                }
              },
              'intravenous-therapy-mexico': {
          ...
          colombia: {
            ...
            courseDetails: {
              'master-class-facial-modeling': {
                ...
                location: 'Bogotá, Colombia',
                price: 'Contactar para precios',
                capacity: 'Grupos reducidos',
                certification: 'Sí',
                overview: [
                  'Formación responsable con los más altos estándares de seguridad, ética y conocimiento científico',
                  'Práctica intensiva de 2 días con productos de calidad certificados internacionalmente',
                  'Protocolos completos sobre indicaciones, contraindicaciones y manejo de eventos adversos',
                  'Certificación internacional avalada por Alianza Americana de Medicina Estética y SOPEME',
                  'Constancia registrada ante STPS (México) con validez curricular',
                  'Productos incluidos: Juvederm-Allergan, Botox-Allergan, Hilos PDO, Harmonyca/Radiesse',
                  'Evaluación de conocimientos, habilidades y destreza al finalizar',
                ],
                targetAudience: {
                  title: 'Curso Dirigido:',
                  highlighted: 'Médicos y odontólogos',
                ...
                prerequisites: [
                  'Título profesional en Medicina o Odontología',
                  'Cédula profesional vigente',
                  'Compromiso con la ética y seguridad del paciente',
                ...
                includes: [
                  ...
                  'Toxina Botulínica Botox-Allergan (certificado FDA, INVIMA, COFEPRIS)',
                  'Hilos PDO Monos o Lisos (certificados internacionales)',
                  'Bioestimulador Harmonyca o Radiesse (certificados internacionales)',
                  'Material didáctico completo',
                  'Certificado internacional al aprobar',
                ...
                testimonial: {
                  title: 'Testimonio Real',
                  subtitle: 'Curso Modelación, Perfilación y Armonización Facial',
                  videoId: 'fThNwH7dFCw',
                },
              },
              'intravenous-therapy-online': {
