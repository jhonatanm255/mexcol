      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="font-headline text-2xl md:text-4xl font-semibold tracking-tight mb-6 text-white">
              {courseDetails.title}
            </h1>
            <p className="text-xl md:text-xl italic text-white/80 mb-8 font-medium">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-4">
              ...
              <CardContent className="space-y-4">
                ...
                >
                  <a 
                    href={`https://wa.me/56950285079?text=${encodeURIComponent(`Hola, quiero más información acerca del ${courseDetails.title}`)}`}
                    target="_blank"
